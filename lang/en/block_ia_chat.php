...
$string['pluginname'] = 'Chat IA para cursos';
$string['meurelatorio'] = 'Mini chat para tirar duvidas sobre o curso';
$string['ia_chat:addinstance'] = 'Adicionar um novo bloco de Chat com IA';
$string['ia_chat:myaddinstance'] = 'Adicionar um novo bloco de Chat com IA ao painel do usuário';
